...
public partial class MISDBEntities : DbContext
{
    public MISDBEntities()
        : base("name=MISDBEntities")
    {
    ...
    public virtual ObjectResult<SP_Follow_Up_Item_Result> SP_Follow_Up_Item()
    {

        return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_Follow_Up_Item_Result>("SP_Follow_Up_Item");
    }
